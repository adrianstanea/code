...
const std::string& Person::get_first_name() const& { return m_first_name; }
std::string&& Person::get_first_name() && { return std::move(m_first_name); }

const std::string& Person::get_last_name() const& { return m_last_name; }
std::string&& Person::get_last_name() && { return std::move(m_last_name); }

const std::string& Person::get_initials() const& { return m_initials; }
std::string&& Person::get_initials() && { return std::move(m_initials); }
...
std::string Person::compute_initials(std::string first_name,
    ...
    auto initials = format("{}.{}", first_name.at(0), last_name.at(0));
